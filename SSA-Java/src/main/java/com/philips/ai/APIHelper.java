...
public class APIHelper {
	 ...
	 * @return The deserialized object
	 */
	public static <T extends Object> T deserialize(String json, Class<T> typeReference) throws IOException {
		if (isNullOrWhiteSpace(json))
			return null;
	...
	private static void loadKeyValuePairForEncoding(String key, Object value,
			List<SimpleEntry<String, Object>> objectList, HashSet<Integer> processed) throws InvalidObjectException {
		if (value == null)
			return;
