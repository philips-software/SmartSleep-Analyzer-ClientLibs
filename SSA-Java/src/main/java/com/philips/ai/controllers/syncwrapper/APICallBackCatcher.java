 ...
 */
package com.philips.ai.controllers.syncwrapper;
 ...
 * completion of the API call. Trying to get results of API call before calling
 * wait() will also block.
 * 
...
public class APICallBackCatcher<T> extends SynchronousBase implements APICallBack<T> {
	...
	/**
	 * Get the exception object thrown by this API callback if any. Blocks if API
	 * call is not complete yet.
	 * 
	 * @return
